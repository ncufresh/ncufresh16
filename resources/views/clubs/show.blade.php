...
<div class="row">
	...
	<div class="col-sm-4 col-xs-12 col-md-3 col-lg-3">
		...
		@endcan
		  ...
		  <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal{{$club->id}}"><img class="img" src="{{$club->clubs_file}}"></button><h2 class="title">{{$club->clubs_intro}}</h2>
