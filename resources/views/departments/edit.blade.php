...
<div class="container">
    ...
    <div class="content">
		...
		<div class="form-group">
			<!-- 修改幻燈片 -->
			<!-- json_decode變陣列 -->
			<?php if ($departments->departments_photo_1 != null) {
			$photo1 = json_decode($departments->departments_photo_1);
			} ?>
			<?php if ($departments->departments_photo_2 != null) {
				$photo2 = json_decode($departments->departments_photo_2);
			} ?>
			<?php if ($departments->departments_photo_3 != null) {
				$photo3 = json_decode($departments->departments_photo_3);
			} ?>
			<?php if ($departments->departments_photo_4 != null) {
				$photo4 = json_decode($departments->departments_photo_4);
			} ?>
			<?php if ($departments->departments_photo_5 != null) {
				$photo5 = json_decode($departments->departments_photo_5);
			} ?>
		@if($photo1 != null)	
			<div class="form-group">
